...
<div id="sidebar" class="sidebar                  responsive                    ace-save-state">
    ...
    <ul class="nav nav-list">
        <li class="">
            <a href="#" class="dropdown-toggle">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-buildings-fill" viewBox="0 0 16 16" style="margin-left: 8px; margin-right: 8px">
    ...
    <ul class="nav nav-list">
        ...
        <ul class="nav nav-list">
            <li class="">
                <a href="#" class="dropdown-toggle">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-fill" viewBox="0 0 16 16" style="margin-left: 8px; margin-right: 8px">
